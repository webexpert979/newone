  ...
  constructor(props) {
    ...
    this.state = {
      navItems: [
        ...
        { id: 2, idnm: "features", navheading: "" },
        { id: 3, idnm: "features", navheading: "" },
      ],
      isOpenMenu: false,
    };
  }
          ...
          header={
            ...
            >
              <Container>
                ...
                <img src={image} height="50px" width="50px" style={{margin:"10px",padding:"0",transform:"scale(1.5)"}}></img>
                </NavbarBrand>
                ...
                >
                  ...
                  <div className="nav-button ml-auto">
                    <Nav className="navbar-right" navbar>
                      <NavItem>
                        <Modal
                          Contract={this.props.multiSender}
                      ...
                      <NavItem className={"active"}>
                        {this.props.walletConnected ? (
                          <NavLink>{this.truncate(this.props.account)}</NavLink>
                        ) : (
                          <p></p>
                        )}
                      </NavItem>
                      <NavItem>
                        {this.props.walletConnected ? (
                          <Button
                            ...
                            onClick={this.props.handleConnectWallet}
                          >
                            Change Wallet
                          </Button>
                        ) : (
